...
import com.space_travel.dao.*;
import com.space_travel.db.SchemaInitializer;
import com.space_travel.model.*;
import com.space_travel.service.BusinessQueryService;
...
public class Main {
    ...
    private static void handleResult(int action) throws SQLException {
        switch (action) {
            ...
            case 3 -> {
                int tid = readInt("ID теста:");
                int aid = readInt("ID астронавта:");
    ...
    private static int readInt(String msg) {
        ...
        while (!in.hasNextInt()) {
            System.out.print("Введите число: "); in.next();
        }
        int val = in.nextInt();
        in.nextLine();
        return val;
